...
var Imp = function(id, bidfloor, tagid, native, banner, bidfloorcur){
  this.id = id;
...
ImpBuilder.prototype.build = function() {
  return new Imp(this._id, this._bidfloor, this._tagid, this._native, this._banner, this._bidfloorcur).removeUndefined();
};
