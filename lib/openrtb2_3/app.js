...
var App = function(storeurl, cat, id, name, publisher, bundle, paid){
...
AppBuilder.prototype.build = function() {
  return new App(this._storeurl, this._cat, this._id, this._name, this._publisher, this._bundle, this._paid).removeUndefined();
};
